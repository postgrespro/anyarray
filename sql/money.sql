...
CREATE INDEX idx_test_money ON test_money USING gin (v _money_aa_ops);
...
DROP INDEX idx_test_money;
CREATE INDEX idx_test_money ON test_money USING rum (v _money_aa_ops);
